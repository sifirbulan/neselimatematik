...
const curriculum:Record<string,Record<string,string[]>>={
  ...
  "Türk Dili ve Edebiyatı":{"9":["Genel Tarama","Sözün İnceliği","Anlam Arayışı","Anlamın Yapı Taşları","Dilin Zenginliği"],"10":["Genel Tarama","Sözün Ezgisi","Kelimelerin Ritmi","Dünden Bugüne","Nesillerin Mirası"],"11":["Genel Tarama","Bir Diyeceğim Var!","Kültür Yolculuğu","Yaşamın İzinde","Hayatın Aynası"],"12":["Genel Tarama","Benim Yolculuğum","Toplumun Ahengi","Hayatın Dengesi","Hayalimdeki Yarın"]},
  Felsefe:{"10":["Genel Tarama","Felsefenin Doğası","Felsefe, Mantık ve Argümantasyon","Varlık Felsefesi","Bilgi Felsefesi","Ahlak Felsefesi","Estetik ve Sanat Felsefesi","Siyaset Felsefesi","Din Felsefesi","Bilim Felsefesi"],"11":["Genel Tarama","Çevre Sorunları ve Felsefe","Teknoloji ve Hayat","Akıl ve İnanç","Edebiyat ve Felsefe","Hayatın Anlamı","Hukuk ve Felsefe"]},
